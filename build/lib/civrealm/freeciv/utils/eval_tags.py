...
EVALUATION_TAGS = [
    'score', 'population', 'economics', 'production', 'cities', 'researched_techs', 'military_units', 'wonders',
    'research_speed', 'land_area', 'settled_area', 'gold', 'units_built', 'units_killed', 'units_lost', 'units_used']
