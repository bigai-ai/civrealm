...
def test_build_road(controller):
    ...
    controller.get_observation()
    print(f"Unit id: {worker_id}, position: ({build_tile['x']}, {build_tile['y']}), extras[EXTRA_ROAD]: {build_tile['extras'][EXTRA_ROAD]}, move left: {unit_opt.unit_ctrl.get_unit_moves_left(punit)}.")
