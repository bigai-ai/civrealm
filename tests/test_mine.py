...
from freeciv_gym.freeciv.map.map_ctrl import DIR8_NORTH
...
def test_mine(controller):
    ...
    controller.get_observation()
    print(f"Unit id: {worker_id}, position: ({build_tile['x']}, {build_tile['y']}), extras[EXTRA_MINE]: {build_tile['extras'][EXTRA_MINE]}, move left: {unit_opt.unit_ctrl.get_unit_moves_left(punit)}.")
